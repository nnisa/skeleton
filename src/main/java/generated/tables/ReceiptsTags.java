...
public class ReceiptsTags extends TableImpl<ReceiptsTagsRecord> {
	...
	private static final long serialVersionUID = 1298991464;
	...
	/**
	 * The column <code>public.receipts_tags.receiptid</code>.
	 */
	public final TableField<ReceiptsTagsRecord, Integer> RECEIPTID = createField("receiptid", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>public.receipts_tags.tagid</code>.
	 */
	public final TableField<ReceiptsTagsRecord, Integer> TAGID = createField("tagid", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
	...
	public UniqueKey<ReceiptsTagsRecord> getPrimaryKey() {
		return Keys.RECEIPT_TAG_PRIMARYKEY;
	}
	...
	public List<UniqueKey<ReceiptsTagsRecord>> getKeys() {
		return Arrays.<UniqueKey<ReceiptsTagsRecord>>asList(Keys.RECEIPT_TAG_PRIMARYKEY);
	}
	...
	public List<ForeignKey<ReceiptsTagsRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<ReceiptsTagsRecord, ?>>asList(Keys.RECEIPT_FOREIGNKEY, Keys.TAG_FOREIGNKEY);
	}
